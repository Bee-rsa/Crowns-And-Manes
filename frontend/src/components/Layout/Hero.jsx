    ...
    <section className="relative -mt-6">
      ...
      <div className="block lg:hidden h-[550px] md:h-[700px] relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0,0,0,1) 10%, rgba(255,255,255,1) 100%)",
          }}
        />
        ...
        <div className="absolute inset-0 flex flex-col mt-28 items-center justify-center px-6">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter font-poppins uppercase mb-4 text-white">
              Premium Human Hair <br /> Wigs in South Africa
            </h1>
          ...
          >
            <img
              src={heroImg}
              alt="Hero"
              className="w-full h-96 sm:h-92 md:h-[600px] object-cover rounded-lg shadow-lg"
            />
          </motion.div>
        </div>
      </div>
